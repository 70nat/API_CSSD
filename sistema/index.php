...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id) {
        ...
        $mensaje = $controller->registro($producto)
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 mb-3">
                        ...
                        <input type="number" name="existencia" class="form-control" min="0"
                               value="<?php echo htmlspecialchars($productoEditar['existencia'] ?? ''); ?>" required>
                    </div>
        ...
        <div class="card-body">
            ...
            <table class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="6" class="text-center">No hay producto registrados.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
